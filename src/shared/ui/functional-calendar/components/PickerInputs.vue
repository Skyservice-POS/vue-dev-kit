    ...
    >
      ...
      >
        <input
          ...
          type="text"
          title="Date"
          v-model="singleSelectedDateModel"
...
export default {
  ...
  computed: {
    // [Vue 3] v-model не можна вішати на проп (singleSelectedDate) — пишемо в
    // calendar.selectedDate, як це робить сеттер однойменного computed у батька.
    singleSelectedDateModel: {
      get() {
        return this.singleSelectedDate
      },
      set(newValue) {
